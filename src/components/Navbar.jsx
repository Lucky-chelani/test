    ...
    <>
      <NavbarWrapper scrolled={scrolled}>
        ...
        <NavLinks isOpen={isOpen}>
          ...
          <Link to="/blog" className={location.pathname === '/blog' || active === 'blog' ? 'active-link' : ''} onClick={handleUpcomingFeature}>Blog</Link>
          <Link to="/profile" className={location.pathname === '/profile' || active === 'profile' ? 'active-link' : ''}>Profile</Link>
        </NavLinks>
